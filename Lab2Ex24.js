...
d3.select("body")
  .append("p")
  .text(
    "Interpolate blends the value of two data values passed as arguments. In the above example two array of elements are passed as argument and the a new range of elements are created between the first and second array for each element."
  );
